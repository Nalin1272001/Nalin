...
use assignment;
Create table Student (Name varchar(20),Roll_num int,Mark int,Grade char(1));
select * from Student;
...
use Assignment;
create table Sales(Columns_ID int(4),Product_Name varchar(20),Price_Per_Unit int,Quantity int );
insert into sales values (1111,'Note',20,1);
